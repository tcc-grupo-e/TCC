    ...
    private SqlConnection conectar()
     {
        ...
        try
        {
            String strConexao = "Password=" + Password + "; Persist Security Info = false; User ID=" + ID + "; Initial Catalog =Auto_Socorro; Data Source=" + Environment.MachineName /*+ " \\SQLEXPRESS"*/;
