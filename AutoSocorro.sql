...
insert into Funcionario values
	...
	'SP', '(11)29958-7064', '00/00/0000', 'Solteiro', '-', '-', 'Luc', '81DC9BDB52D04DC20036DBD8313ED055', 's')
...
Exec usp_PesquisarFuncionariosMotoristas
select * from Funcionario
...
go
exec usp_PesquisarTodasAsChamadas
select * from Funcionario_Abertura
...
drop procedure usp_UltimoIdChamadas
	select * from Destino
----------------------Home-----------------------
...
go
exec usp_PesquisarChamadasDataAbertos '17/06/2019'
----------------Alterar---------------------
...
go
Exec usp_AlterarEmpresa 'Acrone','(11)97502-7389','contato@Acroni.com','65.567.325/0001-04','396.638.830.393','65.567.325/0001-04'
DROP procedure usp_AlterarEmpresa
...
go
drop procedure usp_AlterarFuncionario
Exec usp_AlterarFuncionario  'Eduardo Rocha dkzjxck','Motorista','R$4000.00','lucbonnet10@gmail.com','13901484-x','01246497344','345.92951.31-0','Rua Jesuíno de Arruda','São Paulo','04132-000','SP','(11)96783-2965','06/08/1957','Casado','Rosângela Louise Santos','(11)93789-5092','Motorista'
