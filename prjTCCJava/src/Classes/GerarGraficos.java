...
//          plot.setOutlinePaint(Color.white);
        ...
        renderer.setAutoPopulateSeriesStroke(false);
        renderer.setSeriesPaint(0, new Color(0xed462f));
        renderer.setSeriesPaint(1, new Color(0x54ae0a));
        plot.setRenderer(renderer);
    ...
    public ImageIcon gerarImg(String nome, JFreeChart chart, int width, int height) {//gera o arquivo imagem para o gráfico
        try {
            ChartUtilities.saveChartAsJPEG(new java.io.File("C:\\Users\\Lab\\Desktop\\prjTCCJava\\PrjTCCGrupoEv3.6\\Graficos\\"+nome), chart, width, height);
            BufferedImage img = ImageIO.read(new File("C:\\Users\\Lab\\Desktop\\prjTCCJava\\PrjTCCGrupoEv3.6\\Graficos\\"+nome));
