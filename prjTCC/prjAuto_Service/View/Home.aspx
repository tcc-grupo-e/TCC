...
<asp:Content ID="Content1" ContentPlaceHolderID="oimota" runat="server">
    <main id="c_pricipal_quiz">
        ...
        <br />
        <div class="arts">
            <img src="img/guinchost.png" alt="png de guincho" class="foto">
        </div>
        <%-- <h1 class="ht">Titulo!</h1>--%>




        <h1 class="ht1">Entendemos o Problema e Temos a Solução</h1>

        <p class="tx">
            Sabemos como é difícil atualmente conseguir um bom serviço de guinchos em um curto tempo, por causa disso buscamos oferecer a você, nosso cliente, o melhor atendimento possível em relação ao seus problemas.</p>
