<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastroF.aspx.cs" Inherits="prjAuto_Service.CadastroF" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="HeadF" runat="server">
                         ...
                         <div class="row">
                            <div class="col">
                             <p class="campo">
                                ...
                                <asp:TextBox ID="txtNomeF" class="form-control" runat="server" required OnLoad="txtNomeF_Load"></asp:TextBox>
                                <asp:Label ID="lblNomeF" runat="server" Text="" CssClass="lbl" class="form-text text-muted"></asp:Label>
                            </p>
                            </div>
                            <div class="col">
                              <p class="campo">
                                <label for="u_nome">Nome de usuario :</label>
                                <asp:TextBox ID="txtNomeUsuF" class="form-control" runat="server" required></asp:TextBox>
                                <asp:Label ID="lblNomeUsuF" runat="server" Text="" CssClass="lbl" class="form-text text-muted"></asp:Label>
                            </p>
                            </div>
                          </div>
                        <br />
                          ...
                          <div class="row">
                            <div class="col">
                               <p class="campo">
                                ...
                                <asp:TextBox ID="txtSenhaF" class="form-control" runat="server" TYPE="password" required></asp:TextBox>
                                <asp:Label ID="lblSenhaF" runat="server" Text="" CssClass="lbl" class="form-text text-muted"></asp:Label>
                            </p>
                            </div>
                            <div class="col">
                              <p class="campo">
                                <label for="sr_nome">Repita senha :</label>
                                <asp:TextBox ID="txtReSenhaF" class="form-control" runat="server" TYPE="password" required></asp:TextBox>
                            </p>
                            </div>
                          </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col">
                              <p class="campo">
                                ...
                                <asp:TextBox ID="txtEmailF" class="form-control" runat="server" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required></asp:TextBox>
                                <asp:Label ID="lblEmailF" runat="server" Text="" CssClass="lbl" class="form-text text-muted"></asp:Label>
                            </p>
                            </div>
                            <div class="col">
                              <p class="campo">
                                <label for="re_nome">Repetir E-mail :</label>
                                <asp:TextBox class="form-control" ID="txtReEmailF" runat="server" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required></asp:TextBox>
                            </p>
                            </div>
                          </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col">
                              <p class="campo">
                                ...
                                <asp:TextBox ID="txtTelF" class="form-control" runat="server" pattern="[0-9]+" required></asp:TextBox>
                                <asp:Label ID="lblTelF" runat="server" Text="" CssClass="lbl" class="form-text text-muted"></asp:Label>
                            </p>
                            </div>
                            <div class="col">
                               <p class="campo">
                        ...
                        <div class="form-group">
                            ...
                            <p class="campo">
                                A exibição é efetuada em uma nova janela. Caso seja suprimida a exibição de campos adicionais em um bloqueador de popups, este deve ser primeiro desativado.<p>
                                    ...
                                    <p class="campo1">
                                        <input type="checkbox" name="concordo" class="chec" required>Sim, li e aceito a Sim, li e aceito a declaração de confidencialidade de dados.
                                    </p>
                        </div>
                        <br />
                        <p class="campo">
                            <asp:Button ID="btnCadastroFisica" class="btn btn-primary" runat="server" Text="Enviar" CssClass="btn btn-primary" OnClick="BtnCadastroFisica_Click" />
                        </p>
                    </form>
