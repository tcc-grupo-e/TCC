...
<script runat="server">
    ...
    protected void Unnamed_Click(object sender, EventArgs e)
    {
        ...
        string horario = (Request.QueryString["horario"]);
        String contrabarra = "\\";
        String strConexao = "Password=123456; Persist Security Info=True; User ID=sa; Initial Catalog=AutoSocorro; Data Source=" + Environment.MachineName + contrabarra.Substring(0, 1) + "SQLEXPRESS";
