...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnTela.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                pnTelaKeyPressed(evt);
            }
        });
        ...
        logo.setName(""); // NOI18N
        logo.setOpaque(true);
        pnTela.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 190, 70));
        ...
        pnTela.add(Senha, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, 150, -1));
        ...
        pnTela.add(Login, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 150, -1));
    ...
    FrmCaminhão gf = new FrmCaminhão();
    ...
    private void pnTelaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pnTelaKeyPressed
         if(evt.getKeyChar() == KeyEvent.VK_ENTER)
       {  
        try {
            //login basico
    ...
    }//GEN-LAST:event_pnTelaKeyPressed
