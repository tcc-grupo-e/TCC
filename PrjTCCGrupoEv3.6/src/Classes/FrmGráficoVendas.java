...
public class FrmGráficoVendas extends javax.swing.JFrame {
    ...
    String[] SubServiços = {"Gráficos", "Porcentagem", "Ranking"};
    ...
    private void initComponents() {
        ...
        jPanel3.add(btnSair, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 460, 213, 56));
        ...
        jPanel3.add(btnLogoff, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 400, 213, 60));
        ...
        setSize(new java.awt.Dimension(1200, 599));
    ...
    private void btnGhostMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGhostMouseClicked
        ...
        cbFatores.setSelectedIndex(1);
        cbGraficos.setSelectedIndex(1);
        txtInicio.setValue("01/12/2016");
        txtFim.setValue("01/12/2017");
                ...
                case 1:
                    switch (grafico) {
                        ...
                        case 1:
                            ...
                            icon = ger.gerarInvertedBartest(val.faixaPedido(data), "Serviço por faixa de Hora", lblGrafic.getWidth(), lblGrafic.getHeight(), "pedido");
                ...
                case 2:
                    switch (grafico) {
                        case 1:
                            ...
                            clas.rs = clas.smt.executeQuery(sql);
                            icon = ger.gerarPiechart(clas.rs, "Porcentagem de cada despesa", lblGrafic.getWidth(), lblGrafic.getHeight());
                            lblGrafic.setSize(680, 380);
                            lblGrafic.setIcon(icon);
                            break;
                        case 2:
