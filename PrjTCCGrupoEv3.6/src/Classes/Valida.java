...
public class Valida {
    ...
    public String[] Meses(String In, String Fim) {//divide os meses do periodo escolhido
        ...
        if ((Integer.parseInt(Fim1[2]) != Integer.parseInt(In1[2]))) {
            ...
            meses = Integer.parseInt(Fim1[1]) - Integer.parseInt(In1[1]);
            anos = meses/12;
    ...
    public String[] faixaPedido(String datas) throws SQLException {//busca no banco a quantidade de pedidos por faixa de horario
        String[] data = new String[6];
        String[] hora = new String[]{"10he12h", "12he14h", "14he16h", "16he18h", "18he20h", "20he22h"};
        for (int i = 0; i < 6; i++) {
            clas.getConexao();
            clas.rs = clas.smt.executeQuery("exec usp_PedidoEntre" + hora[i] +" " +  datas);
            if (!clas.rs.next()) {
                data[i] = "0";
            } else {
    ...
    public String[][] VendasDespesas(String Inicio, String Fim) throws SQLException {
        ...
        for (int i = 1; i < count - 1; i++) {
            ...
            clas.rs.next();
            vendas = vendas + (200 * Double.parseDouble(clas.rs.getString("qtde")));
...
//            clas.rs = clas.smt.executeQuery("exec usp_GastoSalario '1'");
//            clas.rs.next();
//            if(a[2]==b[2] || ((Integer.parseInt(a[2]) == Integer.parseInt(b[2]) - 1) && Integer.parseInt(b[1])-Integer.parseInt(a[1])<15))
//            {
//            despesas = Double.parseDouble(clas.rs.getString("qtde"))/12;
//            }
//            else{
//            
//            despesas = Double.parseDouble(clas.rs.getString("qtde"));
