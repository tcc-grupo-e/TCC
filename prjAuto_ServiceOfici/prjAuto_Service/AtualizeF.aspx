<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AtualizeF.aspx.cs" Inherits="prjAuto_Service.AtualizeF" %>
                    ...
                    <form id="formF" runat="server">
                        <div class="form-group">
                            ...
                            <p class="campo">
                                ...
                                <asp:TextBox ID="txtNomeF" class="form-control" runat="server" required></asp:TextBox>
                                <asp:Label ID="lblNomeF" runat="server" Text="" CssClass="lbl" class="form-text text-muted"></asp:Label>
                            </p>
                           
                            <p class="campo">
                                <label for="u_nome">Nome de usuário <span>*</span>:</label>
                            ...
                            <p class="campo">
                                <label for="s_nome">Nova senha <span>*</span>:</label>
                            ...
                            <p class="campo">
                                <label for="sr_nome">Repita nova senha <span>*</span>:</label>
                                <asp:TextBox ID="txtReSenhaF" class="form-control" runat="server" TYPE="password" required></asp:TextBox>
                            </p>
                           
                            <p class="campo">
                                <label for="e_nome">Email Novo<span>*</span>:</label>
                            ...
                            <p class="campo">
                                <label for="s_nome">Telefone <span>*</span>:</label>
                                <asp:TextBox ID="txtTelF" class="form-control" runat="server" pattern="[0-9]+" required></asp:TextBox>
                                <asp:Label ID="lblTelF" runat="server" Text="" class="form-text text-muted" ></asp:Label>
                            </p>
                            
                            <p class="campo">
                                <label for="s_nome">Celular <span>*</span>:</label>
                        ...
                        <br />
                        <p class="campo">
                            <asp:Button ID="btnAtualizeFisica" class="btn btn-primary" runat="server" Text="Enviar" CssClass="btn btn-primary" OnClick="btnAtualizeFisica_Click" />
                        </p>
                    </form>
