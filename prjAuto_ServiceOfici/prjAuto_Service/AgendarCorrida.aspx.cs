...
namespace prjAuto_Service
{
    public partial class AgendarCorrida : System.Web.UI.Page
    {
        ...
        protected void btnAgendar_Click(object sender, EventArgs e)
        {
            ...
            //xx = new ClasseConexao();
            //xx.executa_sql("insert into Servicos values ('AgendaCorrida',400.20," + Session["Cliente"] + ")");
            ds = new DataSet();
            xx = new ClasseConexao();
        ...
        //protected void txtVeiculo_TextChanged(object sender, EventArgs e)
        //{
        //    //if(txtVeiculo.Text == "btnFantasma")
        //    //{
        //    //    txtVeiculo.Text = "Celta";
        //    //    txtCor.Text = "Preto";
        //    //    txtData.Text = "12/12/2018";
